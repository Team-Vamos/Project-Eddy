...
public class SteamManager : MonoBehaviour
{
    ...
    protected virtual void Awake()
    {
        ...
        try
        {
            ...
            if (SteamAPI.RestartAppIfNecessary((AppId_t)1843950))
            {
                Debug.Log(
        ...
        {
            Debug.LogError("스팀 프로세스가 실행중이지 않아 자동으로 실행중입니다 잠시 뒤 다시 시도해 주세요");
            EditorUtility.DisplayDialog("오류", "스팀 프로세스가 실행중이지 않아 자동으로 실행중입니다 잠시 뒤 스팀이 열린 뒤 다시 시도해 주세요", "확인");
